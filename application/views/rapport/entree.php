    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Rapport des entrees de produits en stock</h3>
                <div class="box-tools">
                    <a href="<?php echo site_url('dashboard/viewReport/entree'); ?>" class="btn btn-success btn-sm" onclick="print();">
