    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Creation d'une nouvelle demande</h3>
            ...
            <div class="box-body">
                <div class="row clearfix">
                    <div class="col-md-6">
                        <label for="benef_nom" class="control-label"><span class="text-danger">*</span>Nom du client</label>
                    ...
                    <div class="col-md-6">
                        <label for="benef_postnom" class="control-label"><span class="text-danger">*</span>Postnom du client</label>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <label for="benef_prenom" class="control-label"><span class="text-danger">*</span>Prenom </label>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <label for="benef_phone" class="control-label"><span class="text-danger">*</span>Numero telephone</label>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <label for="benef_adresse" class="control-label"><span class="text-danger">*</span>Adresse du client</label>
                        <div class="form-group">
