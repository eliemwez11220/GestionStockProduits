    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Creation d'un nouveau produit</h3>
            </div>
            <?php echo form_open('intrant/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="libelle" class="control-label"><span class="text-danger">*</span>Libelle ou nom produit</label>
          	...
          	<div class="box-footer">
            	<button type="submit" class="btn btn-success">
            		<i class="fa fa-check"></i> Enregistrer produit
            	</button>
          	</div>
            <?php echo form_close(); ?>
      	</div>
