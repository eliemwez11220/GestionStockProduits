...
<head>
    ...
    <title><?= $title ? $title : 'Bienvenue' ?> | Gestion Demandes Produits Applicattion !</title>
            ...
            <div class="hpanel">
                <div class="panel-body">
                    <div class="text-center m-b-md custom-login">
                        ...
                        <?php } else { ?>
                            <b>Gestion Demandes Produits Application</b>!
                            <p>Connectez-vous pour démarrer votre session.</p>
                        <?php } ?>
                    </div>
                    <form action="<?= base_url('authenticate/login'); ?>" id="loginForm" method="post">
                        <div class="form-group">
                            <label class="control-label" for="username">Nom d'utilisateur ou adresse mail</label>
                ...
                <div class="col-sm-6">
                    <div class="float-left text-left">
                        ...
                        <img src="<?= base_url(); ?>global/img/logo/coding.png"
                            ...
                            | <a href="https://congoagile.com" style="background-color: transparent; color: blue; font-weight: bold;">
                              Gestion Demandes Produits Application</a>
                        </span>
                    </div>
                </div>
                <div class="col-sm-6" >
                    <div class="float-right text-right" style="margin-right: 10px!important;">
                        ...
                        <span class="small" style="background-color: transparent; color: #ffffff; font-weight: bold;">
                            Gestion Demandes Produits et son logo sont des marques déposées de
