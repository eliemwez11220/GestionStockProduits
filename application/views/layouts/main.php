...
<html>
    <head>
        ...
        <title><?= (!empty($title) ? $title: "dashboard"); ?> | Gestion Demandes Produits Application</title>
        <!-- favicon
        ============================================ -->
                    ...
                    <ul class="sidebar-menu">
						...
						<li>
                            ...
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('intrant/add');?>"><i class="fa fa-plus"></i> Nouveau produitt</a>
                                </li>
								<li>
                                    <a href="<?php echo site_url('intrant/index');?>"><i class="fa fa-list-ul"></i> Listing Produits</a>
                                </li>
							</ul>
                        </li>
						...
						<li>
                            <a href="#">
                                <i class="fa fa-arrow-circle-right"></i> <span>Entrees Produits</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('entree/add');?>"><i class="fa fa-plus"></i> Nouvelle entree</a>
                                </li>
								<li>
                        ...
                        <li>
                            <a href="#">
                                <i class="fa fa-refresh"></i> <span>Demandes clients</span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="active">
                                    <a href="<?php echo site_url('demande/add');?>"><i class="fa fa-plus"></i> Nouvelle demande</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="#">
                                <i class="fa fa-print"></i> <span>Rapports</span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="active">
                                    <a href="<?php echo site_url('dashboard/viewReport/sortie');?>"><i class="fa fa-arrow-left"></i> Sortie Produits</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('dashboard/viewReport/entree');?>"><i class="fa fa-arrow-right"></i>Entrees Produits</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('dashboard/viewReport/stock');?>"><i class="fa fa-bookmark-o"></i>Stock Produits</a>
                                </li>
                            </ul>
                        </li>
