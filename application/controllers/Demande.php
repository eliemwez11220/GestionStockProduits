...
class Demande extends CI_Controller{
    ...
    function add()
    {
        ...
        if($this->form_validation->run())
        {
            ...
            //new quqntity
            $new_sortie_qte=is_numeric($this->input->post('qte_demandee'));
            $params = array(
                'benef_nom' => is_string($this->input->post('benef_nom')),
                'benef_postnom' => is_string($this->input->post('benef_postnom')),
                'benef_prenom' => is_string($this->input->post('benef_prenom')),
                'benef_phone' => is_numeric($this->input->post('benef_phone')),
                'benef_adresse' => is_string($this->input->post('benef_adresse')),
