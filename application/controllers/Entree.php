...
class Entree extends CI_Controller{
    ...
    function add()
    {
        ...
        if($this->form_validation->run())
        {
            ...
            //new quqntity
            $new_entry_qte=is_numeric($this->input->post('qte_entree'));
            $params = array(
                'fss_nom' => is_string($this->input->post('fss_nom')),
                'fss_postnom' => is_string($this->input->post('fss_postnom')),
                'fss_prenom' => is_string($this->input->post('fss_prenom')),
                'fss_phone' => is_numeric($this->input->post('fss_phone')),
                'fss_adresse' => is_string($this->input->post('fss_adresse')),
